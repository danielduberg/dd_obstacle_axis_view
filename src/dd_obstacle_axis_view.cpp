#include <dd_obstacle_axis_view/dd_obstacle_axis_view.h>
...
{
DDObstacleAxisViewPanel::DDObstacleAxisViewPanel(QWidget* parent)
    : rviz::Panel(parent), has_recieved_pose_(false)
{
  ...
  px4_pose_sub_ = nh_.subscribe<geometry_msgs::PoseStamped>(
      "/mavros/local_position/pose", 1, &DDObstacleAxisViewPanel::px4PoseCallback, this);

  slam_pose_sub_ = nh_.subscribe<geometry_msgs::PoseStamped>(
      "/mavros/vision_pose/pose", 1, &DDObstacleAxisViewPanel::slamPoseCallback, this);
}

void DDObstacleAxisViewPanel::load(const rviz::Config& config)
{
...
void DDObstacleAxisViewPanel::save(rviz::Config config) const
{
...
void DDObstacleAxisViewPanel::updateTopic()
{
...
void DDObstacleAxisViewPanel::setTopic(const QString& new_in_topic,
      ...
      new_out_topic_temp != nav_goal_3d_out_topic_)
  {
    ...
    else
    {
      nav_goal_2d_sub_ = nh_.subscribe<geometry_msgs::PoseStamped>(
          ...
          &DDObstacleAxisViewPanel::navGoal2DCallback, this);
      try
      {
...
void DDObstacleAxisViewPanel::navGoal2DCallback(
...
void DDObstacleAxisViewPanel::posePublish(geometry_msgs::PoseStamped& pose)
{
...
void DDObstacleAxisViewPanel::updateSlider()
{
...
void DDObstacleAxisViewPanel::updateCurrentZValue()
{
...
void DDObstacleAxisViewPanel::updateMinZValue()
{
...
void DDObstacleAxisViewPanel::updateMaxZValue()
{
...
void DDObstacleAxisViewPanel::px4PoseCallback(
    const geometry_msgs::PoseStamped::ConstPtr& msg)
{
  px4_altitude_->setText(QString::number(msg->pose.position.z, 'f', 2));
}

void DDObstacleAxisViewPanel::slamPoseCallback(
    const geometry_msgs::PoseStamped::ConstPtr& msg)
{
  slam_altitude_->setText(QString::number(msg->pose.position.z, 'f', 2));
}

void DDObstacleAxisViewPanel::republishSetpoint() { posePublish(pose_); }

void DDObstacleAxisViewPanel::cancelSetpoint()
{
  std_msgs::Header msg;
...
PLUGINLIB_EXPORT_CLASS(dd_obstacle_axis_view::DDObstacleAxisViewPanel, rviz::Panel)
